...
interface JoinRequestSubmittedStepProps {
  organisationName: string;
  onDone: () => void;
}

export function JoinRequestSubmittedStep({ organisationName, onDone }: JoinRequestSubmittedStepProps) {
  return (
    <div className="space-y-6">
      <div className="bg-white rounded border border-[#e0e0e0] shadow-[1px_0_20px_rgb(0_0_0_/_8%)] p-8 text-center">
        ...
        <p className="text-[0.875rem] text-[#616161] mb-6">
          Your request to join {organisationName} has been submitted.<br />
          The organisation manager for {organisationName} has been informed.
        </p>
        <button
          onClick={onDone}
