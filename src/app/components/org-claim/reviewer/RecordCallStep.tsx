...
interface RecordCallStepProps {
  onNext: (callRecording: File, comments: string, flag?: { comment: string }) => void;
}

export function RecordCallStep({ onNext }: RecordCallStepProps) {
      ...
      <div className="bg-white rounded border border-[#e0e0e0] shadow-[1px_0_20px_rgb(0_0_0_/_8%)] p-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-[0.875rem] text-[#616161] mb-6">
            Upload the Teams call recording and add any notes from the conversation
          </p>
          ...
          <div className="mb-6">
            ...
            />
            <p className="text-[0.75rem] text-[#616161] mt-2">
              Document any key points, concerns, or unusual behavior during the call
            </p>
          </div>
          ...
          <div className="bg-[#e3f2fd] border border-[#90caf9] rounded-lg p-4 mb-6">
            ...
            <ul className="text-[0.75rem] text-[#212121] space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>PSC confirmed their identity and role</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#00c853] flex-shrink-0 mt-0.5" />
                <span>PSC confirmed claimant's authority to represent organisation</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#00c853] flex-shrink-0 mt-0.5" />
                <span>PSC agreed to send email confirmation</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#00c853] flex-shrink-0 mt-0.5" />
