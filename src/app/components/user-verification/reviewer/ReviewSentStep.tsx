...
export function ReviewSentStep() {
  return (
      ...
      <div className="bg-white rounded border border-[#e0e0e0] shadow-[1px_0_20px_rgb(0_0_0_/_8%)] p-12">
        <div className="text-center max-w-lg mx-auto">
          ...
          <p className="text-[0.875rem] text-[#616161] mb-8">
            This verification has been successfully submitted to the admin approver for final review
          </p>
          ...
          <div className="bg-[#e3f2fd] border border-[#90caf9] rounded-lg p-4 text-left mb-6">
            ...
            <ul className="text-[0.75rem] text-[#212121] space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>The admin approver will review all documents and evidence</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#101F36]">•</span>
                <span>They will either approve or reject the verification</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#101F36]">•</span>
                <span>The user will be notified of the final decision</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#101F36]">•</span>
