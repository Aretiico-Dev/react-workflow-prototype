...
export function ReviewIdStep({ idDocument, extractedDetails, onNext }: ReviewIdStepProps) {
      ...
      <div className="bg-white rounded border border-[#e0e0e0] shadow-[1px_0_20px_rgb(0_0_0_/_8%)] p-6">
        <div className="mb-6">
          ...
          <p className="text-[0.875rem] text-[#616161]">
            Verify that the ID document is valid and the extracted details are accurate
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="bg-[#fafafa] border border-[#e0e0e0] rounded p-3">
                ...
                <p className="text-[0.875rem] text-[#212121]">
                  {[extractedDetails.title, extractedDetails.firstName, extractedDetails.middleName, extractedDetails.lastName, extractedDetails.suffix]
                    .filter(Boolean)
                    .join(' ')}
                </p>
              </div>
              ...
              <div className="bg-[#fafafa] border border-[#e0e0e0] rounded p-3">
                ...
                <p className="text-[0.875rem] text-[#212121]">
                  {new Date(extractedDetails.dateOfBirth).toLocaleDateString('en-GB', {
                    day: 'numeric',
                    month: 'long',
                    year: 'numeric'
                  })}
              ...
              <div className="bg-[#fafafa] border border-[#e0e0e0] rounded p-3">
                ...
                <p className="text-[0.875rem] text-[#212121]">{extractedDetails.idType}</p>
              </div>

              <div className="bg-[#fafafa] border border-[#e0e0e0] rounded p-3">
                <label className="text-[0.75rem] text-[#616161] block mb-1">Country</label>
                <p className="text-[0.875rem] text-[#212121]">{extractedDetails.idCountry}</p>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-[#e3f2fd] border border-[#90caf9] rounded">
              ...
              <ul className="text-[0.75rem] text-[#212121] space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#00c853] flex-shrink-0 mt-0.5" />
                  <span>All corners and edges are visible</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#00c853] flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#00c853] flex-shrink-0 mt-0.5" />
                  <span>No signs of tampering or forgery</span>
                </li>
              </ul>
            </div>
          </div>
